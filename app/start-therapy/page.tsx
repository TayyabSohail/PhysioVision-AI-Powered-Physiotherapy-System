...
export default function StartTherapy() {
  ...
  return (
    <BrowserRouter>
      <div
        className="flex min-h-screen overflow-hidden" // Added overflow-hidden here
        style={{
      ...
      >
        ...
        <div className="flex-1 container mx-auto px-10 py-8 bg-">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="md:w-1/2 text-left space-y-6">
              ...
              <p className="text-lg text-gray-300">
                A personalized fitness companion designed to guide you every
                step of the way. From real-time posture corrections to detailed
          ...
          <div className="!mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 p-10 bg-slate-950 w-full rounded-lg max-w-screen-4xl mx-auto">
